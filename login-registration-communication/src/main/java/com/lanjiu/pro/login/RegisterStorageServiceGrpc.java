...
public final class RegisterStorageServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.lanjiu.pro.login.CheckForUpdatesProtocol,
      com.lanjiu.pro.login.CheckForUpdatesProtocol> getCheckAPPVersionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckAPPVersion",
      requestType = com.lanjiu.pro.login.CheckForUpdatesProtocol.class,
      responseType = com.lanjiu.pro.login.CheckForUpdatesProtocol.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lanjiu.pro.login.CheckForUpdatesProtocol,
      com.lanjiu.pro.login.CheckForUpdatesProtocol> getCheckAPPVersionMethod() {
    io.grpc.MethodDescriptor<com.lanjiu.pro.login.CheckForUpdatesProtocol, com.lanjiu.pro.login.CheckForUpdatesProtocol> getCheckAPPVersionMethod;
    if ((getCheckAPPVersionMethod = RegisterStorageServiceGrpc.getCheckAPPVersionMethod) == null) {
      synchronized (RegisterStorageServiceGrpc.class) {
        if ((getCheckAPPVersionMethod = RegisterStorageServiceGrpc.getCheckAPPVersionMethod) == null) {
          RegisterStorageServiceGrpc.getCheckAPPVersionMethod = getCheckAPPVersionMethod =
              io.grpc.MethodDescriptor.<com.lanjiu.pro.login.CheckForUpdatesProtocol, com.lanjiu.pro.login.CheckForUpdatesProtocol>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CheckAPPVersion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.login.CheckForUpdatesProtocol.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.login.CheckForUpdatesProtocol.getDefaultInstance()))
              .setSchemaDescriptor(new RegisterStorageServiceMethodDescriptorSupplier("CheckAPPVersion"))
              .build();
        }
      }
    }
    return getCheckAPPVersionMethod;
  }

  private static volatile io.grpc.MethodDescriptor<com.lanjiu.pro.login.RequestUserDevice,
      com.lanjiu.pro.login.RequestUserDevice> getUpdateUserDeviceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateUserDevice",
      requestType = com.lanjiu.pro.login.RequestUserDevice.class,
      responseType = com.lanjiu.pro.login.RequestUserDevice.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lanjiu.pro.login.RequestUserDevice,
      com.lanjiu.pro.login.RequestUserDevice> getUpdateUserDeviceMethod() {
    io.grpc.MethodDescriptor<com.lanjiu.pro.login.RequestUserDevice, com.lanjiu.pro.login.RequestUserDevice> getUpdateUserDeviceMethod;
    if ((getUpdateUserDeviceMethod = RegisterStorageServiceGrpc.getUpdateUserDeviceMethod) == null) {
      synchronized (RegisterStorageServiceGrpc.class) {
        if ((getUpdateUserDeviceMethod = RegisterStorageServiceGrpc.getUpdateUserDeviceMethod) == null) {
          RegisterStorageServiceGrpc.getUpdateUserDeviceMethod = getUpdateUserDeviceMethod =
              io.grpc.MethodDescriptor.<com.lanjiu.pro.login.RequestUserDevice, com.lanjiu.pro.login.RequestUserDevice>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateUserDevice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.login.RequestUserDevice.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.login.RequestUserDevice.getDefaultInstance()))
              .setSchemaDescriptor(new RegisterStorageServiceMethodDescriptorSupplier("UpdateUserDevice"))
              .build();
        }
      }
    }
    return getUpdateUserDeviceMethod;
  }
  ...
  public static abstract class RegisterStorageServiceImplBase implements io.grpc.BindableService {
    ...
    public void checkAPPVersion(com.lanjiu.pro.login.CheckForUpdatesProtocol request,
      ...
      asyncUnimplementedUnaryCall(getCheckAPPVersionMethod(), responseObserver);
    }
    ...
    public void updateUserDevice(com.lanjiu.pro.login.RequestUserDevice request,
      ...
      asyncUnimplementedUnaryCall(getUpdateUserDeviceMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getCheckAPPVersionMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.lanjiu.pro.login.CheckForUpdatesProtocol,
                com.lanjiu.pro.login.CheckForUpdatesProtocol>(
                  this, METHODID_CHECK_APPVERSION)))
          .addMethod(
            getUpdateUserDeviceMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.lanjiu.pro.login.RequestUserDevice,
                com.lanjiu.pro.login.RequestUserDevice>(
                  this, METHODID_UPDATE_USER_DEVICE)))
          .build();
    }
  }
  ...
  public static final class RegisterStorageServiceStub extends io.grpc.stub.AbstractStub<RegisterStorageServiceStub> {
    ...
    public void checkAPPVersion(com.lanjiu.pro.login.CheckForUpdatesProtocol request,
        io.grpc.stub.StreamObserver<com.lanjiu.pro.login.CheckForUpdatesProtocol> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCheckAPPVersionMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void updateUserDevice(com.lanjiu.pro.login.RequestUserDevice request,
        io.grpc.stub.StreamObserver<com.lanjiu.pro.login.RequestUserDevice> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getUpdateUserDeviceMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class RegisterStorageServiceBlockingStub extends io.grpc.stub.AbstractStub<RegisterStorageServiceBlockingStub> {
    ...
    /**
     */
    public com.lanjiu.pro.login.CheckForUpdatesProtocol checkAPPVersion(com.lanjiu.pro.login.CheckForUpdatesProtocol request) {
      return blockingUnaryCall(
          getChannel(), getCheckAPPVersionMethod(), getCallOptions(), request);
    }

    /**
     */
    public com.lanjiu.pro.login.RequestUserDevice updateUserDevice(com.lanjiu.pro.login.RequestUserDevice request) {
      return blockingUnaryCall(
          getChannel(), getUpdateUserDeviceMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class RegisterStorageServiceFutureStub extends io.grpc.stub.AbstractStub<RegisterStorageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lanjiu.pro.login.CheckForUpdatesProtocol> checkAPPVersion(
        com.lanjiu.pro.login.CheckForUpdatesProtocol request) {
      return futureUnaryCall(
          getChannel().newCall(getCheckAPPVersionMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lanjiu.pro.login.RequestUserDevice> updateUserDevice(
        com.lanjiu.pro.login.RequestUserDevice request) {
      return futureUnaryCall(
          getChannel().newCall(getUpdateUserDeviceMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_CHECK_APPVERSION = 14;
  private static final int METHODID_UPDATE_USER_DEVICE = 15;
      ...
      switch (methodId) {
        ...
        case METHODID_UPDATE_GUEST_USER_INFO:
          serviceImpl.updateGuestUserInfo((com.lanjiu.pro.login.RequestUser) request,
              (io.grpc.stub.StreamObserver<com.lanjiu.pro.login.ResponseUser>) responseObserver);
          break;
        case METHODID_CHECK_APPVERSION:
          serviceImpl.checkAPPVersion((com.lanjiu.pro.login.CheckForUpdatesProtocol) request,
              (io.grpc.stub.StreamObserver<com.lanjiu.pro.login.CheckForUpdatesProtocol>) responseObserver);
          break;
        case METHODID_UPDATE_USER_DEVICE:
          serviceImpl.updateUserDevice((com.lanjiu.pro.login.RequestUserDevice) request,
              (io.grpc.stub.StreamObserver<com.lanjiu.pro.login.RequestUserDevice>) responseObserver);
          break;
        default:
      ...
      synchronized (RegisterStorageServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCheckAPPVersionMethod())
              .addMethod(getUpdateUserDeviceMethod())
              .build();
        }
      }
    }
