...
public final class FileStorageServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.lanjiu.pro.fileStorage.FriendsTransmissionRequest,
      com.lanjiu.pro.fileStorage.FriendsTransmissionResponse> getCleanFileWithUserIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cleanFileWithUserId",
      requestType = com.lanjiu.pro.fileStorage.FriendsTransmissionRequest.class,
      responseType = com.lanjiu.pro.fileStorage.FriendsTransmissionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lanjiu.pro.fileStorage.FriendsTransmissionRequest,
      com.lanjiu.pro.fileStorage.FriendsTransmissionResponse> getCleanFileWithUserIdMethod() {
    io.grpc.MethodDescriptor<com.lanjiu.pro.fileStorage.FriendsTransmissionRequest, com.lanjiu.pro.fileStorage.FriendsTransmissionResponse> getCleanFileWithUserIdMethod;
    if ((getCleanFileWithUserIdMethod = FileStorageServiceGrpc.getCleanFileWithUserIdMethod) == null) {
      synchronized (FileStorageServiceGrpc.class) {
        if ((getCleanFileWithUserIdMethod = FileStorageServiceGrpc.getCleanFileWithUserIdMethod) == null) {
          FileStorageServiceGrpc.getCleanFileWithUserIdMethod = getCleanFileWithUserIdMethod =
              io.grpc.MethodDescriptor.<com.lanjiu.pro.fileStorage.FriendsTransmissionRequest, com.lanjiu.pro.fileStorage.FriendsTransmissionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "cleanFileWithUserId"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.fileStorage.FriendsTransmissionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.fileStorage.FriendsTransmissionResponse.getDefaultInstance()))
              .setSchemaDescriptor(new FileStorageServiceMethodDescriptorSupplier("cleanFileWithUserId"))
              .build();
        }
      }
    }
    return getCleanFileWithUserIdMethod;
  }
  ...
  public static abstract class FileStorageServiceImplBase implements io.grpc.BindableService {
    ...
    public void cleanFileWithUserId(com.lanjiu.pro.fileStorage.FriendsTransmissionRequest request,
        io.grpc.stub.StreamObserver<com.lanjiu.pro.fileStorage.FriendsTransmissionResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getCleanFileWithUserIdMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getCleanFileWithUserIdMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.lanjiu.pro.fileStorage.FriendsTransmissionRequest,
                com.lanjiu.pro.fileStorage.FriendsTransmissionResponse>(
                  this, METHODID_CLEAN_FILE_WITH_USER_ID)))
          .addMethod(
  ...
  public static final class FileStorageServiceStub extends io.grpc.stub.AbstractStub<FileStorageServiceStub> {
    ...
    public void cleanFileWithUserId(com.lanjiu.pro.fileStorage.FriendsTransmissionRequest request,
        io.grpc.stub.StreamObserver<com.lanjiu.pro.fileStorage.FriendsTransmissionResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCleanFileWithUserIdMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class FileStorageServiceBlockingStub extends io.grpc.stub.AbstractStub<FileStorageServiceBlockingStub> {
    ...
    /**
     */
    public com.lanjiu.pro.fileStorage.FriendsTransmissionResponse cleanFileWithUserId(com.lanjiu.pro.fileStorage.FriendsTransmissionRequest request) {
      return blockingUnaryCall(
          getChannel(), getCleanFileWithUserIdMethod(), getCallOptions(), request);
    }
  ...
  public static final class FileStorageServiceFutureStub extends io.grpc.stub.AbstractStub<FileStorageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lanjiu.pro.fileStorage.FriendsTransmissionResponse> cleanFileWithUserId(
        com.lanjiu.pro.fileStorage.FriendsTransmissionRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getCleanFileWithUserIdMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_CLEAN_FILE_WITH_USER_ID = 5;
  private static final int METHODID_MERGE_GROUP_AVATAR = 6;
      ...
      switch (methodId) {
        ...
        case METHODID_DELETE_FILE_INFORMATION_WITH_GROUP:
          serviceImpl.deleteFileInformationWithGroup((com.lanjiu.pro.fileStorage.GroupTransmissionRequest) request,
              (io.grpc.stub.StreamObserver<com.lanjiu.pro.fileStorage.GroupTransmissionResponse>) responseObserver);
          break;
        case METHODID_CLEAN_FILE_WITH_USER_ID:
          serviceImpl.cleanFileWithUserId((com.lanjiu.pro.fileStorage.FriendsTransmissionRequest) request,
              (io.grpc.stub.StreamObserver<com.lanjiu.pro.fileStorage.FriendsTransmissionResponse>) responseObserver);
          break;
      ...
      synchronized (FileStorageServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCleanFileWithUserIdMethod())
