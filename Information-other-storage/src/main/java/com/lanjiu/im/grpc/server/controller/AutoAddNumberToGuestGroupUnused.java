 ...
 *处理游客群自动派发表的自动补充问题.
 * */
public class AutoAddNumberToGuestGroupUnused {


    private static final Logger logger = Logger.getLogger(AutoAddNumberToGuestGroupUnused.class.getName());
    ...
    //游客群非靓号未使用表自动派发
    public void autoAddNumberToGuestGroupUnusedTable(){
        String typeDef = ConstantsContent.BEAUTIFUL_NUMBER_TYPE_GUEST_GROUP;
        SqlSession session = DBTools.getSession();
        GroupUnusedBeautifulNumberMapper mapperb = session.getMapper(GroupUnusedBeautifulNumberMapper.class);
        //判断游客好友的未使用表中记录数是否小于最低限
        GroupUnusedBeautifulNumberService groupUnusedBeautifulNumberService = new GroupUnusedBeautifulNumberService();
        List<GroupUnusedBeautifulNumber> listGroupUnusedBeautifulNumber = groupUnusedBeautifulNumberService.selectAllRecords(session, mapperb);
        int nLimit = 0;
        ...
        GroupUsedBeautifulNumberMapper mapperbGroupUsedBeautifulNumberMapper = session.getMapper(GroupUsedBeautifulNumberMapper.class);
        GroupUsedBeautifulNumberService groupUsedBeautifulNumberService = new GroupUsedBeautifulNumberService();
        GroupUnusedBeautifulNumber groupUnusedBeautifulNumber = new GroupUnusedBeautifulNumber();
        List<GroupUnusedBeautifulNumber> groupUnusedBeautifulNumberList = null;
        GroupUsedBeautifulNumber groupUsedBeautifulNumber = new GroupUsedBeautifulNumber();
        List<GroupUsedBeautifulNumber> groupUsedBeautifulNumberList = null;
        int nSelectUsed = 0;
        int nSelectUnused = 0;
