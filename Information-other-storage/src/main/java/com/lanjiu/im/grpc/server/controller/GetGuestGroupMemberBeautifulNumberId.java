...
public class GetGuestGroupMemberBeautifulNumberId {

    private static final Logger logger = Logger.getLogger(GetGuestGroupMemberBeautifulNumberId.class.getName());
    ...
    public BeautifulNumberEntity getConfig(){
        ...
        Properties properties = configFileOperationForBeautifulNumber.getGuestGroupMemberBeautifulNumberConfig();
    ...
    public GroupMemberUsedBeautifulNumber judgeAndGetGroupMemberId(SqlSession session, GroupMemberUsedBeautifulNumberMapper mapperbGroupMemberUsedBeautifulNumberMapper, BeautifulNumberEntity beautifulNumberEntity){
        GroupMemberUsedBeautifulNumberService friendUnusedBeautifulNumberService = new GroupMemberUsedBeautifulNumberService();
        GroupMemberUsedBeautifulNumber friendUnusedBeautifulNumber = new GroupMemberUsedBeautifulNumber();
        List<GroupMemberUsedBeautifulNumber> friendUnusedBeautifulNumberList = null;
        int nSelectUnused = 0;
    ...
    public GroupMemberUnusedBeautifulNumber getGuestGroupMemberId(){
        SqlSession session = DBTools.getSession();
        GroupMemberUnusedBeautifulNumberMapper mapperbFriendUnusedBeautifulNumberMapper = session.getMapper(GroupMemberUnusedBeautifulNumberMapper.class);
        GroupMemberUnusedBeautifulNumberService friendUnusedBeautifulNumberService = new GroupMemberUnusedBeautifulNumberService();
        List<GroupMemberUnusedBeautifulNumber> friendUnusedBeautifulNumberList = null;
        GroupMemberUnusedBeautifulNumber friendUnusedBeautifulNumber = new GroupMemberUnusedBeautifulNumber();
                //判断靓号设置是否启动
        ...
        if(null == beautifulNumberEntity){
            ...
            if(ConstantsContent.BEAUTIFUL_NUMBER_SET_COMMON_START.equals(start)){
                //手动派发靓号
                GroupMemberUsedBeautifulNumberMapper mapperbFriendUsedBeautifulNumberMapper = session.getMapper(GroupMemberUsedBeautifulNumberMapper.class);
                GroupMemberUsedBeautifulNumber friendUsedBeautifulNumber = judgeAndGetGroupMemberId(session, mapperbFriendUsedBeautifulNumberMapper, beautifulNumberEntity);
                ...
                //自动派发号码
                friendUnusedBeautifulNumberList = friendUnusedBeautifulNumberService.selectOnlyGroupMemberUnusedBeautifulNumber(session, mapperbFriendUnusedBeautifulNumberMapper);
                //commonUtils.isHave(list)
                CommonUtils<GroupMemberUnusedBeautifulNumber> commonUtils = new CommonUtils<>();
    ...
    public int getGuestGroupMemberIntId(){
        GroupMemberUnusedBeautifulNumber groupMemberUnusedBeautifulNumber = getGuestGroupMemberId();
