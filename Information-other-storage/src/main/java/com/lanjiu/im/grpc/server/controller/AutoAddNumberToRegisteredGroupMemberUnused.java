 ...
 *处理注册群成员自动派发表的自动补充问题.
 * */
public class AutoAddNumberToRegisteredGroupMemberUnused {


    private static final Logger logger = Logger.getLogger(AutoAddNumberToRegisteredGroupMemberUnused.class.getName());
    ...
    //注册群成员非靓号未使用表自动派发
    public void autoAddNumberToRegisteredGroupMemberUnusedTable(){
        String typeDef = ConstantsContent.BEAUTIFUL_NUMBER_TYPE_REGISTERED_GROUP_MEMBER;
        SqlSession session = DBTools.getSession();
        GroupMemberUnusedBeautifulNumberRealMapper mapperb = session.getMapper(GroupMemberUnusedBeautifulNumberRealMapper.class);
        //判断游客好友的未使用表中记录数是否小于最低限
        GroupMemberUnusedBeautifulNumberRealService groupMemberUnusedBeautifulNumberService = new GroupMemberUnusedBeautifulNumberRealService();
        List<GroupMemberUnusedBeautifulNumberReal> listGroupMemberUnusedBeautifulNumber = groupMemberUnusedBeautifulNumberService.selectAllRecords(session, mapperb);
        int nLimit = 0;
        ...
        GroupMemberUsedBeautifulNumberRealMapper mapperbGroupMemberUsedBeautifulNumberMapper = session.getMapper(GroupMemberUsedBeautifulNumberRealMapper.class);
        GroupMemberUsedBeautifulNumberRealService groupMemberUsedBeautifulNumberService = new GroupMemberUsedBeautifulNumberRealService();
        GroupMemberUnusedBeautifulNumberReal groupMemberUnusedBeautifulNumber = new GroupMemberUnusedBeautifulNumberReal();
        List<GroupMemberUnusedBeautifulNumberReal> groupMemberUnusedBeautifulNumberList = null;
        GroupMemberUsedBeautifulNumberReal groupMemberUsedBeautifulNumber = new GroupMemberUsedBeautifulNumberReal();
        List<GroupMemberUsedBeautifulNumberReal> groupMemberUsedBeautifulNumberList = null;
        int nSelectUsed = 0;
        int nSelectUnused = 0;
