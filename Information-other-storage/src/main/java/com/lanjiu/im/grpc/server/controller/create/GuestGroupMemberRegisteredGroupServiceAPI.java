...
public class GuestGroupMemberRegisteredGroupServiceAPI {

    private static final Logger logger = Logger.getLogger(GuestGroupMemberRegisteredGroupServiceAPI.class.getName());

    public GuestGroupMember createGuestGroupMember(RpcRegisteredGroup rpcRegisteredGroup, RpcGuestGroupMember rpcGuestGroupMember){
        //分发注册群成员编号
        ...
        boolean bResult = insertGroupId(session, groupMemberUnusedBeautifulNumber, rpcRegisteredGroup, guestGroupMember);
        if(bResult){
    ...
    public boolean insertGroupId(SqlSession session, GroupMemberUnusedBeautifulNumber groupMemberUnusedBeautifulNumber, RpcRegisteredGroup rpcRegisteredGroup, GuestGroupMember guestGroupMember){
        ...
        RegisteredGroupGuestUserMemberRelation guestGroupGuestUserMemberRelation = generateRegisteredGroupGuestUserMemberRelation(rpcRegisteredGroup, guestGroupMember);
        //
        int result = 0;
        try {
            ...
            result = guestGroupGuestUserMemberRelationMapper.insertRegisteredGroupGuestUserMemberRelation(guestGroupGuestUserMemberRelation.getRegisteredGroupId(),
    ...
    public RegisteredGroupGuestUserMemberRelation generateRegisteredGroupGuestUserMemberRelation(RpcRegisteredGroup rpcRegisteredGroup, GuestGroupMember guestGroupMember){
        RegisteredGroupGuestUserMemberRelation registeredGuestUserMemberRelation = new RegisteredGroupGuestUserMemberRelation();
        Integer registeredGroupGroupId = rpcRegisteredGroup.getGroupId();
        Integer guestUserMemberId = guestGroupMember.getGroupMemberId();
        registeredGuestUserMemberRelation.setGuestUserMemberId(guestUserMemberId);
        registeredGuestUserMemberRelation.setRegisteredGroupId(registeredGroupGroupId);
        return registeredGuestUserMemberRelation;
    }
}
