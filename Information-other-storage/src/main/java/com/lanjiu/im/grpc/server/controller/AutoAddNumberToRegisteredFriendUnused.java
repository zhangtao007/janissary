 ...
 *处理注册好友自动派发表的自动补充问题.
 * */
public class AutoAddNumberToRegisteredFriendUnused {


    private static final Logger logger = Logger.getLogger(AutoAddNumberToRegisteredFriendUnused.class.getName());
    ...
    //注册好友非靓号未使用表自动派发  Real
    public void autoAddNumberToRegisteredFriendUnusedRealTable(){
        String typeDef = ConstantsContent.BEAUTIFUL_NUMBER_TYPE_REGISTERED_FRIEND;
        SqlSession session = DBTools.getSession();
        FriendUnusedBeautifulNumberRealMapper mapperb = session.getMapper(FriendUnusedBeautifulNumberRealMapper.class);
        ...
        List<FriendUnusedBeautifulNumberReal> listFriendUnusedBeautifulNumber = friendUnusedBeautifulNumberService.selectAllRecords(session, mapperb);
        int nLimit = 0;
        ...
        FriendUsedBeautifulNumberRealService friendUsedBeautifulNumberService = new FriendUsedBeautifulNumberRealService();
        ...
        FriendUsedBeautifulNumberReal friendUsedBeautifulNumber = new FriendUsedBeautifulNumberReal();
        List<FriendUsedBeautifulNumberReal> friendUsedBeautifulNumberList = null;
        int nSelectUsed = 0;
        int nSelectUnused = 0;
