package com.lanjiu.im.grpc.client.login_regist.login_storageAPI;


import com.lanjiu.im.grpc.client.login_regist.LoginRegistCommon;
import com.lanjiu.im.grpc.utils.ConstType;
...
public class RegistUserAPI {
    ...
    public RequestUserDevice updateUserDevice(RequestUserDevice request){
        LoginRegistCommon loginRegistCommon = new LoginRegistCommon();
        RequestUserDevice responseUserDevice = loginRegistCommon.updateUserDevice(request);
