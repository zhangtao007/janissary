...
public class ConstType {
    ...
    public static final String EXCEPTION ="服务异常";
    ...
    public static final String TIME_CLEAR_NOTIFY = "###在线消息定期清理通知### ";
    ...
    public  final  static  String AVC_PUSH = "AVC_PUSH";
    public  final  static  String AVC_REMOVE = "AVC_REMOVE";
    public  final  static  String AVC_STORAGE_SUCCESS = "音视频消息存储成功";
    public  final  static  String AVC_STORAGE_FAILURE = "音视频消息存储失败";
    //房间关闭消息
    public  final  static  String ROOM_CLOSE="close";
    public  final  static String STATUS_REPORT_RECEIPT_OFFLINE ="RECEIPT_OFFLINE";
