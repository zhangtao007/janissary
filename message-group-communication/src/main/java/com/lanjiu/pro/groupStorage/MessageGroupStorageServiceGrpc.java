...
public final class MessageGroupStorageServiceGrpc {
  ...
  private static final int METHODID_SELECT_OFF_LINE_GROUP_MSG = 2;
  private static final int METHODID_SELECT_OFF_LINE_GROUP_MSG_COUNT = 3;
  private static final int METHODID_DELETE_GROUP_MEMBERS_OFF_LINE_MSG = 4;
  private static final int METHODID_DELETE_SEND_OFF_LINE_MSG = 5;
