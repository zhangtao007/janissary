...
public final class RegisterStorageServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice,
      com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice> getUpdateUserDeviceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateUserDevice",
      requestType = com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice.class,
      responseType = com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice,
      com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice> getUpdateUserDeviceMethod() {
    io.grpc.MethodDescriptor<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice, com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice> getUpdateUserDeviceMethod;
      ...
      synchronized (RegisterStorageServiceGrpc.class) {
        if ((getUpdateUserDeviceMethod = RegisterStorageServiceGrpc.getUpdateUserDeviceMethod) == null) {
          RegisterStorageServiceGrpc.getUpdateUserDeviceMethod = getUpdateUserDeviceMethod =
              io.grpc.MethodDescriptor.<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice, com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateUserDevice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice.getDefaultInstance()))
  ...
  public static abstract class RegisterStorageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void updateUserDevice(com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice request,
        io.grpc.stub.StreamObserver<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice,
                com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice>(
  ...
  public static final class RegisterStorageServiceFutureStub extends io.grpc.stub.AbstractStub<RegisterStorageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice> updateUserDevice(
        com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice request) {
      return futureUnaryCall(
  ...
  private static final int METHODID_UPDATE_USER_DEVICE = 2;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_UPDATE_USER_DEVICE:
          serviceImpl.updateUserDevice((com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice) request,
              (io.grpc.stub.StreamObserver<com.lanjiu.pro.login.RegisterStorageProto.RequestUserDevice>) responseObserver);
          break;
        default:
