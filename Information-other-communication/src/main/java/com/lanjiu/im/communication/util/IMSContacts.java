...
public interface IMSContacts {
    ...
    interface ResponseCode {
        ...
        int RESPONSE_CODE_EMPTY_RESULT = 300;

        int RESPONSE_CODE_FAILURE = 500;
    }
    ...
    interface MsgType {
        ...
        //好友重新上线（通知好友消息服务捞取离线消息）
        String AGAIN_USER_ONLINE_REGIST = "10103" + UserType.REGISTERED_USER;
        String AGAIN_USER_ONLINE_TOURIST = "10104" + UserType.TOURISTS_USER;

        //删除好友离线消息的指令
        String DEL_FRIEND_OFF_MESSAGE_REGIST = "10106" + UserType.REGISTERED_USER;
        String DEL_FRIEND_OFF_MESSAGE_TOURIST = "10107" + UserType.TOURISTS_USER;

        //离线消息推送成功返回响应（删除好友离线消息）
        String OFF_MESSAGE_SEND_REGIST = "10108" + UserType.REGISTERED_USER;
        String OFF_MESSAGE_SEND_TOURIST =  "10109" + UserType.TOURISTS_USER;
        ...
        //游客退出
        String TOURIST_EXIT = "10110"+UserType.TOURISTS_USER;
        //群成员列表
        String GROUP_MEMBER_LIST = "10111000";
        //搜索群
        String SEARCH_ALLGROUP_BY_USERID = "10111001";
        //群成员删除
        String GROUP_MEMBER_DELETE = "10111002";
        //群成员退出群聊
        String GROUP_MEMBER_EXIT_GROUP="10111003";
        //修改群成员备注
        String GROUP_MEMBER_COMMENT = "10111004";
    }
