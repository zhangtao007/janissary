package com.lanjiu.im.communication.handler;
...
public class HeartBeatRespHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        //接收客户端心跳信息
        if (message.getHead() != null && message.getHead().getMsgType() == ConstantsContent.MSGTYPE_HEARTBEAT_REQUEST) {
            //清零心跳失败计数器
...
//    }
    ...
    private BusinessProtocolMessageStandard.CheckUnifiedEntranceMessage buildHeartBeat() {
        BusinessProtocolMessageStandard.Head header = BusinessProtocolMessageStandard.Head.newBuilder().setMsgType(ConstantsContent.MSGTYPE_HEARTBEAT_REQUEST).build();
