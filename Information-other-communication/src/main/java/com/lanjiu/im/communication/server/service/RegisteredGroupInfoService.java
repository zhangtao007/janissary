...
public class RegisteredGroupInfoService {
    ...
    public BusinessProtocolMessageStandard.CheckUnifiedEntranceMessage selectRegisteredGroupInformation(BusinessProtocolMessageStandard.UnifiedEntranceMessage unifiedEntranceMessage, BusinessProtocolMessageStandard.Head head){
        ...
        BusinessProtocolEntities.RegisteredUser  registeredUser = unifiedEntranceMessage.getGroupInfoProtocol().getRegisteredUser();
        ...
        if(IMSContacts.UserType.REGISTERED_USER.equals(registeredGroup.getGroupType())){
            transmissionRequest = TransmissionRequest.newBuilder()
                    .setRequestKind(ConstantsSelectKind.REGISTERED_GROUP_AND_GROUP_MEMBER_SELECT_BY_GROUP_ID)
