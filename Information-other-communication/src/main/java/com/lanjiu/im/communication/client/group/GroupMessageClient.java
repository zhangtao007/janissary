...
import static com.lanjiu.im.communication.server.ChannelList.channelGroupMessageGroup;

public class GroupMessageClient {

    public static void linkGroupMessageServer(BusinessProtocolMessageStandard.CheckUnifiedEntranceMessage checkUnifiedEntranceMessage) throws Exception{
        int nChannel = channelGroupMessageGroup.size();
        if(nChannel >= 1){
            channelGroupMessageGroup.writeAndFlush(checkUnifiedEntranceMessage);
        }else {
    ...
    public static void linkServer(BusinessProtocolMessageStandard.CheckUnifiedEntranceMessage checkUnifiedEntranceMessage) throws Exception{
        ...
        PropertyConf propertyConf = new PropertyConf("/group_message_server.properties");
        ...
        try {
            ...
            bootstrap.group(eventLoopGroup).channel(NioSocketChannel.class).handler(new ChannelInitializer<SocketChannel>() {
                ...
                protected void initChannel(SocketChannel ch) throws Exception {
                    ...
                    pipeline.addLast(new  GroupHeartBeatReqHandler());
