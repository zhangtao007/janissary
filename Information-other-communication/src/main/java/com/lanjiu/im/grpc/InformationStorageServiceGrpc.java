...
public final class InformationStorageServiceGrpc {
  ...
  private static final int METHODID_SELECT_GROUP_MEMBER_NICKNAME = 33;
  private static final int METHODID_INSERT_FRIEND_UNUSED_BEAUTIFUL_NUMBER = 34;
  private static final int METHODID_INSERT_FRIEND_USED_BEAUTIFUL_NUMBER = 35;
  private static final int METHODID_INSERT_GROUP_ANNOUNCEMENTS = 36;
  private static final int METHODID_INSERT_GROUP_MEMBER_UNUSED_BEAUTIFUL_NUMBER = 37;
  private static final int METHODID_INSERT_GROUP_MEMBER_USED_BEAUTIFUL_NUMBER = 38;
  private static final int METHODID_INSERT_GROUP_UNUSED_BEAUTIFUL_NUMBER = 39;
  private static final int METHODID_INSERT_GROUP_USED_BEAUTIFUL_NUMBER = 40;
  private static final int METHODID_INSERT_GUEST_GROUP = 41;
  private static final int METHODID_INSERT_GUEST_GROUP_ADMINISTRATOR = 42;
  private static final int METHODID_INSERT_GUEST_GROUP_GUEST_USER_MEMBER_RELATION = 43;
  private static final int METHODID_INSERT_GUEST_GROUP_MEMBER = 44;
  private static final int METHODID_INSERT_GUEST_GROUP_REGISTERED_USER_MEMBER_RELATION = 45;
  private static final int METHODID_INSERT_GUEST_USER_FRIEND = 46;
  private static final int METHODID_INSERT_OFFLINE_MESSAGE_PRIORITY = 47;
  private static final int METHODID_INSERT_REGISTERED_GROUP = 48;
  private static final int METHODID_INSERT_REGISTERED_GROUP_ADMINISTRATOR = 49;
  private static final int METHODID_INSERT_REGISTERED_GROUP_GUEST_USER_MEMBER_RELATION = 50;
  private static final int METHODID_INSERT_REGISTERED_GROUP_MEMBER = 51;
  private static final int METHODID_INSERT_REGISTERED_GROUP_REGISTERED_USER_MEMBER_RELATION = 52;
  private static final int METHODID_INSERT_REGISTERED_USER_FRIEND = 53;
  private static final int METHODID_INSERT_GROUP_UNUSED_BEAUTIFUL_NUMBER_REAL = 54;
  private static final int METHODID_INSERT_GROUP_USED_BEAUTIFUL_NUMBER_REAL = 55;
  private static final int METHODID_INSERT_GROUP_MEMBER_UNUSED_BEAUTIFUL_NUMBER_REAL = 56;
  private static final int METHODID_INSERT_GROUP_MEMBER_USED_BEAUTIFUL_NUMBER_REAL = 57;
  private static final int METHODID_INSERT_FRIEND_UNUSED_BEAUTIFUL_NUMBER_REAL = 58;
  private static final int METHODID_INSERT_FRIEND_USED_BEAUTIFUL_NUMBER_REAL = 59;
  private static final int METHODID_INSERT_GROUP_REMARK = 60;
  private static final int METHODID_INSERT_INVITE_USERS_JOIN_GROUP = 61;
  private static final int METHODID_INSERT_GROUP_PHOTO_URL = 62;
  private static final int METHODID_UPDATE_FRIEND_UNUSED_BEAUTIFUL_NUMBER = 63;
  private static final int METHODID_UPDATE_FRIEND_USED_BEAUTIFUL_NUMBER = 64;
  private static final int METHODID_UPDATE_GROUP_ANNOUNCEMENTS = 65;
  private static final int METHODID_UPDATE_GROUP_MEMBER_UNUSED_BEAUTIFUL_NUMBER = 66;
  private static final int METHODID_UPDATE_GROUP_MEMBER_USED_BEAUTIFUL_NUMBER = 67;
  private static final int METHODID_UPDATE_GROUP_UNUSED_BEAUTIFUL_NUMBER = 68;
  private static final int METHODID_UPDATE_GROUP_USED_BEAUTIFUL_NUMBER = 69;
  private static final int METHODID_UPDATE_GUEST_GROUP = 70;
  private static final int METHODID_UPDATE_GUEST_GROUP_ADMINISTRATOR = 71;
  private static final int METHODID_UPDATE_GUEST_GROUP_GUEST_USER_MEMBER_RELATION = 72;
  private static final int METHODID_UPDATE_GUEST_GROUP_MEMBER = 73;
  private static final int METHODID_UPDATE_GUEST_GROUP_REGISTERED_USER_MEMBER_RELATION = 74;
  private static final int METHODID_UPDATE_GUEST_USER_FRIEND = 75;
  private static final int METHODID_UPDATE_OFFLINE_MESSAGE_PRIORITY = 76;
  private static final int METHODID_UPDATE_REGISTERED_GROUP = 77;
  private static final int METHODID_UPDATE_REGISTERED_GROUP_ADMINISTRATOR = 78;
  private static final int METHODID_UPDATE_REGISTERED_GROUP_GUEST_USER_MEMBER_RELATION = 79;
  private static final int METHODID_UPDATE_REGISTERED_GROUP_MEMBER = 80;
  private static final int METHODID_UPDATE_REGISTERED_GROUP_REGISTERED_USER_MEMBER_RELATION = 81;
  private static final int METHODID_UPDATE_REGISTERED_USER_FRIEND = 82;
  private static final int METHODID_UPDATE_GROUP_UNUSED_BEAUTIFUL_NUMBER_REAL = 83;
  private static final int METHODID_UPDATE_GROUP_USED_BEAUTIFUL_NUMBER_REAL = 84;
  private static final int METHODID_UPDATE_GROUP_MEMBER_UNUSED_BEAUTIFUL_NUMBER_REAL = 85;
  private static final int METHODID_UPDATE_GROUP_MEMBER_USED_BEAUTIFUL_NUMBER_REAL = 86;
  private static final int METHODID_UPDATE_FRIEND_UNUSED_BEAUTIFUL_NUMBER_REAL = 87;
  private static final int METHODID_UPDATE_FRIEND_USED_BEAUTIFUL_NUMBER_REAL = 88;
  private static final int METHODID_UPDATE_GROUP_REMARK = 89;
  private static final int METHODID_UPDATE_REG_GROUP_MEMBER_REMARK = 90;
  private static final int METHODID_DELETE_FRIEND_UNUSED_BEAUTIFUL_NUMBER = 91;
  private static final int METHODID_DELETE_FRIEND_USED_BEAUTIFUL_NUMBER = 92;
  private static final int METHODID_DELETE_GROUP_ANNOUNCEMENTS = 93;
  private static final int METHODID_DELETE_GROUP_MEMBER_UNUSED_BEAUTIFUL_NUMBER = 94;
  private static final int METHODID_DELETE_GROUP_MEMBER_USED_BEAUTIFUL_NUMBER = 95;
  private static final int METHODID_DELETE_GROUP_UNUSED_BEAUTIFUL_NUMBER = 96;
  private static final int METHODID_DELETE_GROUP_USED_BEAUTIFUL_NUMBER = 97;
  private static final int METHODID_DELETE_GUEST_GROUP = 98;
  private static final int METHODID_DELETE_GUEST_GROUP_ADMINISTRATOR = 99;
  private static final int METHODID_DELETE_GUEST_GROUP_GUEST_USER_MEMBER_RELATION = 100;
  private static final int METHODID_DELETE_GUEST_GROUP_MEMBER = 101;
  private static final int METHODID_DELETE_GUEST_GROUP_REGISTERED_USER_MEMBER_RELATION = 102;
  private static final int METHODID_DELETE_GUEST_USER_FRIEND = 103;
  private static final int METHODID_DELETE_OFFLINE_MESSAGE_PRIORITY = 104;
  private static final int METHODID_DELETE_REGISTERED_GROUP = 105;
  private static final int METHODID_DELETE_REGISTERED_GROUP_ADMINISTRATOR = 106;
  private static final int METHODID_DELETE_REGISTERED_GROUP_GUEST_USER_MEMBER_RELATION = 107;
  private static final int METHODID_DELETE_REGISTERED_GROUP_MEMBER = 108;
  private static final int METHODID_DELETE_REGISTERED_GROUP_REGISTERED_USER_MEMBER_RELATION = 109;
  private static final int METHODID_DELETE_REGISTERED_USER_FRIEND = 110;
  private static final int METHODID_DELETE_GROUP_UNUSED_BEAUTIFUL_NUMBER_REAL = 111;
  private static final int METHODID_DELETE_GROUP_USED_BEAUTIFUL_NUMBER_REAL = 112;
  private static final int METHODID_DELETE_GROUP_MEMBER_UNUSED_BEAUTIFUL_NUMBER_REAL = 113;
  private static final int METHODID_DELETE_GROUP_MEMBER_USED_BEAUTIFUL_NUMBER_REAL = 114;
  private static final int METHODID_DELETE_FRIEND_UNUSED_BEAUTIFUL_NUMBER_REAL = 115;
  private static final int METHODID_DELETE_FRIEND_USED_BEAUTIFUL_NUMBER_REAL = 116;
  private static final int METHODID_DELETE_GROUP_REMARK = 117;
  private static final int METHODID_DELETE_GUEST_RELATED_ALL_INFO = 118;
  private static final int METHODID_DELETE_MEMBERS_BY_GROUP_OWNER = 119;
  private static final int METHODID_GROUP_MEMBER_EXIT_GROUP_CHAT = 120;
