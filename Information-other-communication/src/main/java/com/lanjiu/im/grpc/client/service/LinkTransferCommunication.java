...
public class LinkTransferCommunication {
    ...
    public AllGroupsMemberResponse insertInviteUsersJoinGroupService(TransmissionRequest request){
        blockingStub = linkTransferCommunication();
        AllGroupsMemberResponse response;
        response = blockingStub.insertInviteUsersJoinGroup(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public AllGroupsMemberResponse selectGroupMembersInfoList(SelectGroupMemberRequest request){
        blockingStub = linkTransferCommunication();
        AllGroupsMemberResponse response;
        response = blockingStub.selectGroupMembersInfoList(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public AllGroupsMemberResponse searchAllGroupByUserId(TransmissionRequest request){
        blockingStub = linkTransferCommunication();
        AllGroupsMemberResponse response = blockingStub.searchAllGroupByUserId(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public AllGroupsMemberResponse GroupOwnerDeleteMember(TransmissionRequest request){
        blockingStub = linkTransferCommunication();
        AllGroupsMemberResponse response = blockingStub.deleteMembersByGroupOwner(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public AllGroupsMemberResponse groupMemberExitGroup(TransmissionRequest request){
        blockingStub = linkTransferCommunication();
        AllGroupsMemberResponse response = blockingStub.groupMemberExitGroupChat(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public RegisteredGroupMemberResponse updateRegisteredGroupMemberRemark(TransmissionRequest request){
        blockingStub = linkTransferCommunication();
        RegisteredGroupMemberResponse response = blockingStub.updateRegGroupMemberRemark(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public GroupMemberNicknameResponse selectGroupMemberNickname(TransmissionRequest request) {
        blockingStub = linkTransferCommunication();
        GroupMemberNicknameResponse nicknameResponse = blockingStub.selectGroupMemberNickname(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public AllGroupsMemberResponse insertGroupPhotoUrl(TransmissionRequest request) {
        blockingStub = linkTransferCommunication();
        AllGroupsMemberResponse allGroupsMemberResponse = blockingStub.insertGroupPhotoUrl(request);
        try {
            InformationStorageClient.shutdownNow();
        } catch (InterruptedException e) {
            e.printStackTrace();
