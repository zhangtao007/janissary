package com.lanjiu.im.regist.utils;
...
public class ConstType {
    ...
    public static final String GUEST_LOGOUT_FAILURE = "GUEST_LOGOUT_FAILURE";
    public static final String GUEST_LOGOUT_SUCCESS = "GUEST_LOGOUT_SUCCESS";
    public static final String REGIST_LOGOUT_SUCCESS = "REGIST_LOGOUT_SUCCESS";
    public static final String REGIST_LOGOUT_FAILURE = "REGIST_LOGOUT_FAILURE";
    ...
    public static final String QUERY_USERINFO_SUCCESS = "query userinfo success";
    public static final String QUERY_USERINFO_FAILURE = "query userinfo failure";
    public static final String REGIST_PHONE_ISUSED = "regist phone is used";
    ...
    public static final Integer CLEAN_TIME_DEFAULT = 3;  //用户默认清理周期为3天
