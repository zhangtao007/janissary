...
public interface IMSContacts {
    ...
    interface MsgType {
        ...
        //服务器之间使用
        //IMServer检测用户重新上线
        String USER_ONLINE_REGIST = "20001" +  UserType.REGISTERED_USER;
        String USER_ONLINE_TOURIST = "20002" +  UserType.TOURISTS_USER;

        //IMServer检测用户掉线
        String USRE_OFFLINE_REGIST = "20003" + UserType.REGISTERED_USER;
        String USER_OFFLINE_TOURIST = "20004" +  UserType.TOURISTS_USER;
