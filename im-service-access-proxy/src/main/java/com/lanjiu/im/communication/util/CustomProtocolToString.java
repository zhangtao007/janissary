...
public class CustomProtocolToString {
    ...
    public String toStringCheckForUpdatesProtocol(BusinessProtocolMessages.CheckForUpdatesProtocol checkForUpdatesProtocol) {
        return checkForUpdatesProtocol.getDeviceType() +
                checkForUpdatesProtocol.getVersionCode() +
                checkForUpdatesProtocol.getVersionName() +
                checkForUpdatesProtocol.getIsConstraint() +
                checkForUpdatesProtocol.getUpdatePath() +
                checkForUpdatesProtocol.getUpdateDescribe();
    }
    ...
    public String toStringBindingPushServicesProtocol(BusinessProtocolMessages.BindingPushServicesProtocol bindingPushServicesProtocol) {
        return bindingPushServicesProtocol.getUserId() +
                bindingPushServicesProtocol.getPushToken() +
                bindingPushServicesProtocol.getManufacturer() +
                bindingPushServicesProtocol.getStatusDetail();
    }
